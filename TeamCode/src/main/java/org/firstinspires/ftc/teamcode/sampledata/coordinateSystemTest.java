...
public class coordinateSystemTest extends LinearOpMode {
    ...
    static final Pose2d startpose = new Pose2d(0, 0, Math.toRadians(0));
    ...
    public void runOpMode() {
        ...
        Trajec = drive.trajectoryBuilder(new Pose2d(1,0,0))
        ...
        while(opModeIsActive()) {
            ...
            if(gamepad1.b){
                telemetry.addData("findID",ObjectCheck());
            }
            ...
            nowx += gamepad1.left_stick_x;
            nowy += gamepad1.left_stick_y;
            nowa += gamepad1.right_stick_x;
            gotoPosition(nowx,nowy,nowa);

            telemetry.addData("nowx",nowx);
            telemetry.addData("nowy",nowy);
            telemetry.addData("nowa",nowa);
