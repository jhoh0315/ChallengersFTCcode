...
@Autonomous(name="RedRear", group="Pushbot", preselectTeleOp="main_control")
public class RedRear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (findID ==  1)      gotoPosition(-60,-25,180);
        ...
        if (findID != 1) gotoPosition(-60,-25,90);;
        gotoPosition(-65,0,0);
        gotoPosition(20,0,0);
        ...
        else if (findID ==  2)    gotoPosition(50,-30,0);
        else                      gotoPosition(50,-36,0);
