...
@Autonomous(name="BlueRear", group="Pushbot", preselectTeleOp="main_control")
public class BlueRear extends LinearOpMode {
    ...
    static final Pose2d startpose = new Pose2d(-36, -64 * isBlue, Math.toRadians(-90 * isBlue));
    ...
    public void runOpMode() {
        ...
        gotoPosition(-45,-49,-90);

        //goto TargetPostition
        if (findID ==  1)      gotoPosition(-66,-25,180);
        else if (findID ==  2) gotoPosition(-33,-38,-90);
        else                   gotoPosition(-39,-25,180);
        ...
        if (findID != 1) gotoPosition(-66,-25,90);;
        gotoPosition(-65,0,0);
        gotoPosition(20,0,0);
        gotoPosition(20,-30,0);




        //goto backboard
        if (findID == 1) gotoPosition(48,-24,0);
        else if (findID ==  2)    gotoPosition(48,-30,0);
        else                      gotoPosition(48,-36,0);
