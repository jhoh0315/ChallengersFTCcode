...
@Autonomous(name="Auto", group="Pushbot", preselectTeleOp="main_control")
public class Auto extends LinearOpMode {
    static final int aud_speed = 3;
    static final int al_speed = 10;
    static final int al_min = -2500;
    static final int al_max = 0;
    static final double aprilMultiple = 23/27;

    static final int isBlue = -1; //  Blue -> -1  ,  Red -> 1
    static final Pose2d startpose = new Pose2d(12, -64 * isBlue, Math.toRadians(-90 * isBlue));
    ...
    public void runOpMode() {
        ...
        if (findID ==  1) gotoPosition(13,-33,0);
        else if (findID ==  2) gotoPosition(12,-37,-90);
        else gotoPosition(36,-33,0);
        ...
        //goto backboard
        if (findID == 1)       gotoPosition(50,-30,0);
        else if (findID ==  2) gotoPosition(50,-36,0);
        else                   gotoPosition(50,-42,0);
    ...
    public int ObjectCheck() {
        while(true){
            ...
            for (Recognition recognition : currentRecognitions) {
                ...
                if (((recognition.getLabel() == "RED_TES" && isBlue == 1)
